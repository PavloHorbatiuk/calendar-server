...
export class EventsService {
	...
	async create(createEventDto: CreateEventDto, user): Promise<UserResponse> {
	...
	async findAll(user: user): Promise<UserResponse[]> {
	...
	async update(id: number, updateEventDto: UpdateEventDto): Promise<UserResponse> {
